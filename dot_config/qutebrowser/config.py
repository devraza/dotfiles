...
def tokyonight(c, options = {}):
    palette = {
        ...
        'background-attention': '#111111',
        'border': '#111111',
        'current-line': '#9b6b97',
        'selection': '#111111',
        'foreground': '#fefefa',
        'foreground-alt': '#fefefa',
        'foreground-attention': '#fefefa',
        'comment': '#7b6b97',
        'green': '#69f961',
        'blue': '#64c7fc',
        'magenta': '#e572c8',
...
c.fonts.tabs.selected = '10.5pt Iosevka'
c.fonts.tabs.unselected = '10.5pt Iosevka'
c.fonts.hints = '10.5pt Iosevka'
c.fonts.keyhint = '10.5pt Iosevka'
c.fonts.prompts = '10.5pt Iosevka'
c.fonts.downloads = '10.5pt Iosevka'
c.fonts.statusbar = '10.5pt Iosevka'
c.fonts.contextmenu = '10.5pt Iosevka'
c.fonts.messages.info = '10.5pt Iosevka'
c.fonts.debug_console = '10.5pt Iosevka'
c.fonts.completion.entry = '10.5pt Iosevka'
c.fonts.completion.category = '10.5pt Iosevka'
